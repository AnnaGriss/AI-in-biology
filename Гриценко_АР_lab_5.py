...
def classification_training(data):
    ...
    dt_model = DecisionTreeClassifier(
        max_depth=7, # Среднее значение. 
        min_samples_split=10, #Минимальное количество образцов во внетреннем узле. 
        min_samples_leaf=5, # Среднее значение для минимального количества образцов в листе. 
        random_state=37 
    )
